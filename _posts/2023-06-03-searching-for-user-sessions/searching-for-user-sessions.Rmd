...
"reset" and starts again (here I use `dplyr::if_else()` which would not be necessary
...
specific events per session. For our example we might want to look into which search
filters are used regularly by our customers and which almost never that could be removed.
