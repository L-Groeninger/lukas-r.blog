...
I will break it down in several steps.
...
With the help of the developer tool view we can select the element of interest and
copy the xpath. In the case of the *specs* table this was "//*[@id='specs']".
For the ID, the price or the number of views, these are different xpaths which
...
```{r include=FALSE}
boat_df <- read_csv(here::here("_posts/2021-12-27-scraping-used-boats/data", 
                               "sailboats3.csv"), 
...
Now we can do some analysis, picking our favorite boat etc. We could calculate 
...
```{r include=FALSE}
df_e <- readRDS(here::here("_posts/2021-12-27-scraping-used-boats/data", 
                               "df_e.RDS")) |> 
