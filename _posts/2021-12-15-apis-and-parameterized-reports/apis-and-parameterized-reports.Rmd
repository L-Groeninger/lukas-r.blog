...
One of the biggest strengths of R is its ability to produce beautiful reports and articles.
...
Let's say we want to know how the stock prices of different social networks 
performed in 2020? Were all companies equally affected by the Corona Virus?
What we want as well is to be able to change the set of companies as well as the 
year if interest programmatically when rendering the report. 

To include parameters in our report we have to define them first in the 
