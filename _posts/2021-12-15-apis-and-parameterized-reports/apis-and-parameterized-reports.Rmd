...
library(here)
library(simfinapi)
library(httr)       # communicating with API's through R
...
```{r echo=FALSE}
#| fig.cap = "Inserting our url in the browser"
knitr::include_graphics(here::here("_posts/2021-12-15-apis-and-parameterized-reports/img", 
                                   "get_request_browser.PNG"))
```
